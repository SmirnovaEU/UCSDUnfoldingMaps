...
public abstract class EarthquakeMarker extends CommonMarker
{
	...
	private List<ScreenPosition> threadCities;
	...
	public List<ScreenPosition> getCities(){
		return threadCities;
	}
	
	public void setCities(List <ScreenPosition> markers) {
		this.threadCities = markers;
