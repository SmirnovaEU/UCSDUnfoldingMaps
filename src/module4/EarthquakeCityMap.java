...
public class EarthquakeCityMap extends PApplet {
	...
	private void addKey() {	
		...
		fill(color(255, 0, 0));
		triangle(50, 115, 55, 105, 60, 115);
		
		fill(color(255, 255, 255));
		ellipse(55, 140, 14, 14);
		rect(48, 163, 14, 14);
		fill(color(255, 255, 0));
		ellipse(55, 230, 12, 12);
		fill(color(0, 0, 255));
		ellipse(55, 250, 12, 12);
		fill(color(255, 0, 0));
		ellipse(55, 270, 12, 12);
		fill(color(255, 255, 255));
		ellipse(55, 290, 12, 12);
		line(55-6, 290-6, 55+6, 290+6);
		line(55+6, 290-6, 55-6, 290+6);
		
		fill(0, 0, 0);
		text("City Marker", 70, 110);
		text("Land Quake", 70, 140);
		text("Ocean Quake", 70, 170);
		text("Size ~ Magnitude", 50, 200);
		text("Shallow", 70, 230);
		text("Intermediate", 70, 250);
		text("Deep", 70, 270);
